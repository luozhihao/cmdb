...
<template>
    <div class="clearfix">
        ...
        <div class="text-center btn-operate">
            ...
            <button type="button" class="btn btn-default" @click="$broadcast('showRamModal')">
                新增
            </button>
            <dropdown v-el:deleteconfirm>
                ...
                <div slot="dropdown-menu" class="dropdown-menu pd20">
                    <button type="button" class="btn btn-danger btn-block" @click="checkedFn('/equipment/mem_delete/', 'deleteconfirm')">确定</button>
...
import createRam from './CreateRam.vue'
