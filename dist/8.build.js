	    ...
	    methods: {
	        ...
	        saveFn: function saveFn() {
	            if (this.businessType === '1') {
	                ...
	                if (this.gameList && this.department && this.productLevel && this.gameType && this.platformType && this.developModel && this.phase && this.maintainManagers.length) {
